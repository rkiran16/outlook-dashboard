...
var Item = (function (_super) {
    ...
    function Item(obj) {
        _super.call(this, obj instanceof TypeContainer_1.TypeContainer.ExchangeService ? obj : obj instanceof TypeContainer_1.TypeContainer.ItemAttachment ? obj.Service : null); //info: cannot check instanceof to avoid circular dependency in js. TypeContainer is workaround 
    ...
    Item.prototype.Bind = function (service, id, propertySet) {
    ...
    Item.prototype.InternalUpdate = function (parentFolderId, conflictResolutionMode, messageDisposition, sendInvitationsOrCancellationsMode, suppressReadReceipts) {
        ...
        return PromiseFactory_1.PromiseFactory.resolve(returnedItem);
    };
