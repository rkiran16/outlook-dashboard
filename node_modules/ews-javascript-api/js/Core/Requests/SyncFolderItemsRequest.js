...
var SyncFolderItemsRequest = (function (_super) {
    ...
    SyncFolderItemsRequest.prototype.Validate = function () {
        ...
        if (this.Service.RequestedServerVersion < ExchangeVersion_1.ExchangeVersion.Exchange2010 &&
            this.syncScope != SyncFolderItemsScope_1.SyncFolderItemsScope.NormalItems) {
            throw new ServiceVersionException_1.ServiceVersionException(ExtensionMethods_1.StringHelper.Format(Strings_1.Strings.EnumValueIncompatibleWithRequestVersion, SyncFolderItemsScope_1.SyncFolderItemsScope[this.syncScope], "SyncFolderItemsScope", ExchangeVersion_1.ExchangeVersion.Exchange2010));
        }
        ...
        if (this.Service.RequestedServerVersion < ExchangeVersion_1.ExchangeVersion.Exchange2013 &&
            this.NumberOfDays != 0) {
            throw new ServiceVersionException_1.ServiceVersionException(ExtensionMethods_1.StringHelper.Format(Strings_1.Strings.ParameterIncompatibleWithRequestVersion, "numberOfDays", ExchangeVersion_1.ExchangeVersion.Exchange2013));
        }
