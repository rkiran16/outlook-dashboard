...
var ServiceResponse = (function () {
    ...
    ServiceResponse.prototype.ReadElementsFromXmlJsObject = function (jsObject, service) {
        ...
        var caller = this.constructor.name || "ServiceResponse->child";
        EwsLogging_1.EwsLogging.Assert(false, caller + ".ReadElementsFromXmlJsObject", "BatchProcessingStopped is true but ReadElementsFromXmlJsObject is not available in derived class to call.");
    };
    /**
