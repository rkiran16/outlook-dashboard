...
var ComplexPropertyCollection = (function (_super) {
    ...
    function ComplexPropertyCollection() {
        _super.call(this);
        this.___implementsInterface = ["ISelfValidate", "IJsonSerializable", "IEnumerable<TComplexProperty>", "ICustomUpdateSerializer", "IJsonCollectionDeserialize"];
        this.___typeName = "ComplexPropertyCollection";
        this.___typeGenerics = ["ComplexProperty"];
        this.items = []; //System.Collections.Generic.List<TComplexProperty>;
        this.addedItems = []; //System.Collections.Generic.List<TComplexProperty>;
        this.modifiedItems = []; //System.Collections.Generic.List<TComplexProperty>;
        this.removedItems = []; //System.Collections.Generic.List<TComplexProperty>;
    }
    Object.defineProperty(ComplexPropertyCollection.prototype, "Items", {
         ...
         * @return The items.
         */
        get: function () { return this.items; } //System.Collections.Generic.List<TComplexProperty>;
        ,
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ComplexPropertyCollection.prototype, "AddedItems", {
         ...
         */
        get: function () { return this.addedItems; } //System.Collections.Generic.List<TComplexProperty>;
        ,
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ComplexPropertyCollection.prototype, "ModifiedItems", {
         ...
         */
        get: function () { return this.modifiedItems; } //System.Collections.Generic.List<TComplexProperty>;
        ,
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ComplexPropertyCollection.prototype, "RemovedItems", {
         ...
         */
        get: function () { return this.removedItems; } //System.Collections.Generic.List<TComplexProperty>;
        ,
        enumerable: true,
        configurable: true
    });
     ...
     */
    ComplexPropertyCollection.prototype.__thisIndexer = function (index) {
     ...
     */
    ComplexPropertyCollection.prototype.CreateComplexProperty = function (xmlElementName) { throw new Error("abstract - ComplexPropertyCollection.ts - CreateComplexProperty : Not implemented."); };
    /**
     * @internal Creates the default complex property.
     *
     * @return  {TComplexProperty}      Complex property instance.
     */
    ComplexPropertyCollection.prototype.CreateDefaultComplexProperty = function () { throw new Error("abstract - ComplexPropertyCollection.ts - CreateDefaultComplexProperty : Not implemented."); };
    /**
     ...
     */
    ComplexPropertyCollection.prototype.GetCollectionItemXmlElementName = function (complexProperty) { throw new Error("abstract - ComplexPropertyCollection.ts - GetCollectionItemXmlElementName : Not implemented."); };
     ...
     */
    ComplexPropertyCollection.prototype.IndexOf = function (complexProperty) { return this.items.indexOf(complexProperty); };
    ...
    ComplexPropertyCollection.prototype.InternalRemove = function (complexProperty) {
        ...
        if (ExtensionMethods_1.ArrayHelper.RemoveEntry(this.items, complexProperty)) {
    ...
    ComplexPropertyCollection.prototype.InternalToJson = function (service) { throw new Error("ComplexPropertyCollection.ts - InternalToJson : Not implemented."); };
    /**
    ...
    ComplexPropertyCollection.prototype.UpdateFromXmlJsObjectCollection = function (jsObjectCollection, service) {
        ...
        for (var _i = 0, collection_2 = collection; _i < collection_2.length; _i++) {
            ...
            if (jsonProperty != null) {
                ...
                var actualComplexProperty = this.__thisIndexer(index++);
