...
var SearchFilterCollection = (function (_super) {
    ...
    function SearchFilterCollection(logicalOperator, searchFilters) {
        if (logicalOperator === void 0) { logicalOperator = LogicalOperator_1.LogicalOperator.And; }
        if (searchFilters === void 0) { searchFilters = []; }
        _super.call(this);
        this.searchFilters = [];
        ...
        if (arguments.length === 2) {
            if (searchFilters instanceof Array) {
                ...
                throw new ArgumentException_1.ArgumentOutOfRangeException("searchFilters", "Can not use non Array argument for searchFilters, c# params not supported");
            }
        }
    }
    ...
    SearchFilterCollection.prototype.AddRange = function (searchFilters) {
        ...
        for (var _i = 0, searchFilters_1 = searchFilters; _i < searchFilters_1.length; _i++) {
            var searchFilter = searchFilters_1[_i];
            searchFilter.OnChange.push(this.SearchFilterChanged);
        }
    ...
    SearchFilterCollection.prototype.Clear = function () {
        if (this.Count > 0) {
            for (var _i = 0, _a = this.searchFilters; _i < _a.length; _i++) {
                var searchFilter = _a[_i];
